...
static rohc_comp_state_t rohc_comp_rfc5225_ip_udp_decide_state(const struct rohc_comp_ctxt *const context)
                                           ...
                                           rohc_packet_t *const packet_type)
{
	...
	*packet_type = ROHC_PACKET_UNKNOWN;
	...
	/* STEP 1: decide state */
	{
		const rohc_comp_state_t next_state = rohc_comp_rfc5225_ip_udp_decide_state(context);
